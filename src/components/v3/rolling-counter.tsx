...
export default function RollingCounter() {
  ...
  return (
    <>
      <SectionHeader
        index="05"
        tag={language === "es" ? "sección 05 / rolling counter" : "section 05 / rolling counter"}
        title={language === "es" ? "CONTADOR" : "COUNTER"}
        caption={language === "es" ? "los números se ganan" : "numbers are earned"}
      />
      ...
      <div ref={ref} style={{ position: "relative" }}>
        ...
        >
          ...
          >
            {language === "es" ? "métricas / datos / cifras" : "metrics / data / figures"}
          </span>
...
function Stat({
  ...
  return (
    ...
    >
      <span className="v3-count-label">{copyText(stat.label)}</span>
